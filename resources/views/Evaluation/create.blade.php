				...
				<div class="row">
					<div class="col-md-6 border-right">
						<div class="form-group">
							...
							{{-- <input type="text" class="form-control"  placeholder="Employee Username" name="username"> --}}
							<select class="form-control" name="username">
								<option></option>
							@foreach($users as $user)

							<option  style ="red" value="{{ $user->user_id }}">{{ $user->name }}</option>
					 ...
					 @endforeach
						...
						<div class="form-group">
							...
							{{-- <input type="text" class="form-control"  placeholder="Examinor" name="examiner_id"> --}}

							<select class="form-control" name="examiner_id">
								<option></option>
							@foreach($users as $user)

...
<div class="container">
    <form method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="start_date" name="start_date" placeholder="{!! $activity->start_date !!}"
                type="date" />
        </div>
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="end_date" name="end_date" placeholder="{!! $activity->end_date !!}"
                type="date" />
        </div>
        ...
        <div class="form-group">
            <label>
                @if(auth()->user()->role_id==3)
           <input type="checkbox" name="status" {!! $activity->status == 3 ?"checked":""!!} >
